...
export default {
  ...
  computed: {
    userNav () {
      ...
      return this.$themeLocale.nav || themeData.nav || []
    },
    ...
    nav () {
      ...
      //   const themeLocales = this.$theme.locales || {}
    ...
    repoLabel () {
      ...
      if (themeConfig.repoLabel) {
        return themeConfig.repoLabel
      }
