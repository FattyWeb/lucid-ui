<template>
  <div class="con-components">
    <div class="con-logo vuesax-logo">
      <img class="not-darken" src="/lucid-only.png" alt="">
      <img class="has-darken" src="/lucid-only-b.png" alt="">
    ...
    <div class="content-components">
      ...
      <div class="component5">
        ...
        <p>
          VueJS的组件库，使用几行代码快速创建应用实例。清晰，明澈
        </p>
      </div>
      ...
      <div class="component7">
        ...
        <div class="content-text">
          ...
          <p>
            Lucid是一个开源ui框架 您可以在许多细节之处 发现我们的用心
          </p>
        </div>

        <footer>
          <vs-input v-model="input1" placeholder="添加评论" />
      ...
      <div :class="{'active': focusSelect}" class="component9">
        <header>
          <input v-model="selectValue" placeholder="你最喜爱的运动员" @blur="handleBur" @click="handleClick" readonly type="text" name="" id="select">
        ...
        >
          <li @click="handleClickOption('史蒂芬 库里')">
            史蒂芬 库里
          </li>
          <li @click="handleClickOption('凯文 德布劳内')">
            凯文 德布劳内
          </li>
          <li @click="handleClickOption('罗杰 费德勒')">
            费德勒
          </li>
        </ul>
      </div>
      ...
      <div :class="{'active': focusDrop}" class="component11">
        <header>
          <input placeholder="展开下拉" @blur="handleBurDrop" @click="handleClickDrop" readonly type="text" name="" id="">
          <i class='bx bx-chevron-down'></i>
        </header>
      ...
      <div class="component12">
        <vs-input v-model="input2" placeholder="搜索" />
        <vs-button icon>
      ...
      <div class="component13">
        <header>
          <vs-input v-model="input3" placeholder="探索"></vs-input>
          <button>
