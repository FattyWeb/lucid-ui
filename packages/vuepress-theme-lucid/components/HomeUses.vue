<template>
  <div class="con-twits">
    <header>
      <h2>
        以下是我们用到的 <b>库</b> <b>语言</b> 和相关 <b>技术选型</b>
      </h2>
    </header>
    ...
    twits: [
      {
        ...
        img: '/use/vuejs-lucid-1.png'
      },
      {
        name: 'Javascript',
        link: null,
        img: '/use/js-javaScript-lucid.png'
      },
      {
        name: 'Typescript',
        link: 'https://www.typescriptlang.org/',
        img: '/use/typescript-lucid.png'
      },
      {
        name: 'Sass',
        link: 'https://sass-lang.com/',
        img: '/use/sass-lucid-4.png'
      },
      {
        name: 'Vuepress',
        link: 'https://vuepress.vuejs.org/',
        img: '/use/vuepress-lucid-5.png'
      },
      {
        name: 'Babel',
        link: 'https://babeljs.io/',
        img: '/use/babel-lucid-6.png'
      },
      {
        name: 'Jest',
        link: 'https://jestjs.io/',
        img: '/use/jest-lucid-8-w.svg',
        img2: '/use/jest-lucid-8.svg',
        notShadow: true
      },
      {
        name: 'Boxicons',
        link: 'https://boxicons.com/',
        img: '/use/boxicons-lucid-10.png',
        img2: '/use/boxicons-lucid-9.png'
      },
      {
        name: 'Adobe XD',
      ...
      },
      {
        ...
        img: '/use/webpack-lucid-13.png',
        img2: '/use/webpack-lucid-12.png'
      },
      {
        name: 'Illustrator',
        link: 'https://www.adobe.com/products/illustrator.html',
        img: '/use/illustrator-lucid-11.png'
      },
    ]
  }),
  watch:{
