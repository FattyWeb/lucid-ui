  ...
  <footer class="footer">
    ...
    <div class="subscribe-content" id="mc_embed_signup">
      <div class="con-form">
        ...
        <h4 v-else>
          <b>订阅</b> 我们 <br> 以获取每周的更新
        </h4>
        <form action="" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
            <div id="mc_embed_signup_scroll">

          <input type="email" value="" name="EMAIL" class="email" id="mce-EMAIL" placeholder="输入邮箱 (功能尚未完善)" required>
            <!-- real people should not fill this in and expect good things - do not remove this or risk form bot signups-->
            <div style="position: absolute; left: -5000px;" aria-hidden="true">
              <input type="text" name="b_0437617d8716e89975fcc0f14_8188b99f63" tabindex="-1" value=""></div>
              <div class="clear">
                <input type="button" value="订阅我们!" name="subscribe" id="mc-embedded-subscribe" class="button">
              </div>
            </div>
        </form>
      </div>
      ...
      links:[
        ...
        },
        {
          ...
          items: [
            ...
            {
              text: 'Github',
              link: 'https://github.com/FattyWeb/lucid-ui'
            },
            {
              text: '隐私政策',
              link: '/license/'
        ...
        },
        {
          ...
          items: [
            {
              text: 'Github Issues',
              link: 'https://github.com/FattyWeb/lucid-ui/issues'
            },
            // {
