  ...
  <div class="con-license">
    <header>
      <div class="con-img-header">
        <img class="not-darken" src="/licence-white-lucid.svg" alt="">
        <img class="has-darken" src="/licence-dark-lucid.svg" alt="">
      </div>
...
export default {
  ...
  methods: {
    ...
    openContact() {
      window.open('mailto:dewenzhang012@gmail.com', '_self')
    }
  }
}
</script>
