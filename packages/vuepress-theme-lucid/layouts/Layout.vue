...
export default {
  ...
  created() {
    this.codesandbox = reactive(this.$codesandbox)
  },
    ...
    loadDarkModeFavicon() {
      (function(mod){
        ...
        function initSwitcher(delay) {
          ...
          const intervalId = setInterval(faviconApplyLoop, delay || 300)
...
<!--<style src="@vuepress/plugin-palette/palette" lang="stylus"></style>-->
